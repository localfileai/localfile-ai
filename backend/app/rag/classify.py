...
LABEL_DEFINITIONS: dict[Category, str] = {
    ...
    Category.PROJECT: "팀 프로젝트의 목표와 계획. 기능 명세, 개발 일정, 역할 분담이 담긴 문서",
    ...
    Category.ADMIN: "장학금, 등록금, 증명서 등 학교 행정 처리를 안내하는 문서. 신청 기간과 제출 서류가 담긴 안내문",
    Category.PERSONAL: "여행 계획, 이사 준비, 생활 체크리스트 같은 개인 생활 문서",
}
