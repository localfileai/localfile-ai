    ...
    <div className="flex-1 overflow-y-auto bg-[#F8F9FA] p-8">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="space-y-1">
          <h2 className="text-xl font-bold text-gray-900">현재 폴더 보유 파일 목록</h2>
        ...
        <div className="bg-white rounded-2xl border border-gray-200/80 p-6 shadow-2xs space-y-4">
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-gray-100 text-[11px] text-gray-400 font-bold">
                ...
                {fileList.length === 0 ? (
                  ...
                  fileList.map((file) => (
                    <tr key={file.id} className="hover:bg-gray-50/60 transition">
                      ...
                      <td className="py-3 pr-3 font-bold text-gray-800">{file.name}</td>
                      <td className="py-3 pr-3 text-gray-400 font-mono text-[11px]">
                        {file.path}
                      </td>
