      ...
      <div className="space-y-6">
        ...
        <div className="pt-2">
          ...
          <nav className="space-y-1.5">
            ...
            <button
              onClick={() => onMenuChange('rename')}
              className={`w-full flex items-center gap-3 px-3.5 py-2.5 rounded-xl font-semibold text-xs transition cursor-pointer ${
                currentMenu === 'rename' ? 'bg-indigo-50/80 text-indigo-600' : 'text-gray-500 hover:bg-gray-100/60'
              }`}
            >
              <img className="w-4 h-4" src="component-12.svg" alt="파일·폴더명 변경" />
              <span>파일·폴더명 변경</span>
            </button>
