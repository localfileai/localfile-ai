...
export default function Sidebar({
  ...
  return (
    <aside className="w-64 bg-[#F8F9FA] border-r border-gray-200/80 flex flex-col justify-between p-6 h-screen shrink-0">
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-[11px] text-gray-400 font-medium">Local document manager</div>
          </div>
        </div>

        {/* 메뉴 네비게이션 */}
        <div className="pt-2">
          <div className="text-[11px] font-bold text-gray-400 tracking-wider uppercase mb-3 px-1">
            Workspace
          </div>
          <nav className="space-y-1.5">
            ...
            >
              ...
              {badgeCount > 0 && (
                <span className="px-2 py-0.5 text-[10px] bg-indigo-100 text-indigo-600 font-bold rounded-full">
                  {badgeCount}
                </span>
              )}
            </button>
