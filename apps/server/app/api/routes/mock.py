...
SEARCH_SAMPLE = [
    {
        ...
        "ext": "PDF",
        "path": "Documents/대학교/2025/캡스톤",
        "modified": "2025-06-13",
        "score": 97,
        "snippet": "2025년 캡스톤디자인 프로젝트로, 지역 소상공인을 위한 <mark>가치가게</mark> 플랫폼을 개발하였다.",
    },
    {
        "name": "QR키오스크_설계서.txt",
        "ext": "TXT",
        "path": "Documents/프로젝트/QR-Kiosk",
        "modified": "2025-06-02",
        "score": 92,
        "snippet": "JSP, Tomcat, MySQL을 사용한 <mark>QR 키오스크 프로젝트</mark>의 데이터베이스 구조를 정리한다.",
    },
    {
        "name": "논문학습플랫폼_README.md",
        "ext": "MD",
        "path": "Documents/GitHub/paper-learning",
        "modified": "2025-07-27",
        "score": 89,
        "snippet": "PDF 문단 추출, 요약, 퀴즈 생성을 지원하는 <mark>논문 학습 플랫폼</mark> 프로젝트이다.",
    },
    {
        ...
        "modified": "2026-06-23",
        "score": 87,
        "snippet": "TAS와 CBS+TAS의 지터, 지연, 처리량을 비교하여 <mark>네트워크 스케줄링</mark> 성능을 분석하였다.",
    },
]
...
async def mock_search(q: str = "", types: str = "", date: str = "all", sort: str = "score"):
    ...
    if ql:
        items = [
            i
            for i in items
            if ql in i["name"].lower() or ql in i["path"].lower() or ql in i["snippet"].lower()
        ]
    if date == "2025":
...
RENAME_SAMPLE = [
    ...
    },
    {
        "id": 2,
        "old": "발표자료2.pdf",
        "next": "TSN_TAS_CBS_성능비교_발표자료.pdf",
        "path": "연구/TSN",
        "ext": "PDF",
        "confidence": 93,
    },
    ...
    },
    {
        "id": 4,
        "old": "readme최종.md",
        "next": "논문학습플랫폼_README.md",
        "path": "프로젝트/Paper-Learning",
        "ext": "MD",
        "confidence": 88,
    },
]
...
CURRENT_FILES_SAMPLE = [
    ...
    {
        "id": "tsn",
        "name": "TSN_TAS_CBS_성능비교_발표자료.pdf",
        "ext": "PDF",
        "path": "Documents/바탕화면",
    },
    {"id": "qr", "name": "QR키오스크_DB설계_메모.txt", "ext": "TXT", "path": "Documents/다운로드"},
    {
        ...
        "name": "운영체제_기말정리.pdf",
        "ext": "PDF",
        "path": "Documents/대학교/2025/강의자료/운영체제",
    },
    {
        "id": "data",
        "name": "데이터통신_변조복조.md",
        "ext": "MD",
        "path": "Documents/대학교/2025/강의자료/데이터통신",
    },
    {
        "id": "paper",
        "name": "논문학습플랫폼_README.md",
    ...
    },
    {
        ...
        "name": "발표코칭앱_기획서.pdf",
        "ext": "PDF",
        "path": "Documents/프로젝트/Speech-Coach",
    },
    {
        "id": "result",
        "name": "TSN_실험결과.txt",
        "ext": "TXT",
        "path": "Documents/연구/TSN/실험결과",
    },
]
...
MOVE_SAMPLE = [
    ...
    },
    {
        "id": "tsn",
        "name": "TSN_TAS_CBS_성능비교_발표자료.pdf",
        "from_": "Documents/바탕화면",
        "to": "Documents/연구/TSN/발표자료",
        "confidence": 93,
    },
    {
        "id": "qr",
        "name": "QR키오스크_DB설계_메모.txt",
        "from_": "Documents/다운로드",
        "to": "Documents/프로젝트/QR-Kiosk/설계",
        "confidence": 90,
    },
]
...
@router.post(
    ...
    responses={200: {"content": {"application/json": {"example": {"applied": 2, "status": "ok"}}}}},
)
...
@router.post(
    ...
    responses={
        200: {
            "content": {
                "application/json": {
                    "example": {"message": "reanalyzed", "rename_count": 4, "move_count": 3}
                }
            }
        }
    },
...
async def mock_reanalyze():
    ...
    return {
        "message": "reanalyzed",
        "rename_count": len(RENAME_SAMPLE),
        "move_count": len(MOVE_SAMPLE),
    }
